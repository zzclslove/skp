...
function goods_list($is_delete, $real_goods=1, $conditions = '')
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT goods_id, seller_note, goods_name, goods_type, goods_sn, virtual_sales, shop_price, is_on_sale, is_best, is_new, is_hot, sort_order, goods_number, integral, " .
...
function product_list($goods_id, $conditions = '')
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT product_id, goods_id, goods_attr, product_sn, product_number, product_cleandiscount
