...
$sql = "SELECT o.order_id, o.order_sn, o.add_time, o.order_status, o.shipping_status, o.goods_amount, o.money_paid, o.callback_status," .
    ...
    " LEFT JOIN " .$GLOBALS['ecs']->table('users'). " AS u ON u.user_id=o.user_id where " . $where;
$row = $GLOBALS['db']->getAll($sql);
foreach ($row AS $key => $value){
    $word = new word();
    $word->start();
    $wordname = $value['order_sn'].".doc";
    $consignee = ucwords($value['consignee']);
    $address = ucwords($value['address'].', '.$value['city']. ', '.$value['states']);
    $tel = $value['tel'];
    $city = ucwords($value['city']);
    $country = strtoupper($value['region']);
    ...
    $amount = intval($value['goods_amount'] / 10);
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
 ...
 <tr style=\'mso-yfti-irow:6;height:25.95pt\'>
  ...
  style=\'mso-spacerun:yes\'>&nbsp;&nbsp; </span>'.$consignee.'<o:p></o:p></span></p>
  </td>
 </tr>
 <tr style=\'mso-yfti-irow:7;page-break-inside:avoid;height:21.3pt\'>
  ...
  TimesNewRomanPSMT-Identity-H;mso-font-kerning:0pt\'><o:p>&nbsp;</o:p></span></p>
  </td>
 </tr>
 <tr style=\'mso-yfti-irow:8;height:46.15pt\'>
  ...
  Arial;mso-font-kerning:0pt\'>'.$address.'</span></p>
  </td>
 </tr>
 ...
 <tr style=\'mso-yfti-irow:11;height:23.4pt\'>
  ...
  <p class=MsoNormal style=\'line-height:125%\'><span lang=EN-US
  style=\'mso-bidi-font-size:10.5pt;line-height:125%;font-family:Arial;
  mso-font-kerning:0pt\'>'.$city.'<o:p>&nbsp;</o:p></span></p>
  </td>
  <td width=144 colspan=2 valign=top style=\'width:108.0pt;border-top:none;
  border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  ...
  font-family:Arial;mso-font-kerning:0pt\'>'.$zipcode.'<o:p></o:p></span></p>
  </td>
 </tr>
 <tr style=\'mso-yfti-irow:12;height:23.0pt\'>
  ...
  <p class=MsoNormal style=\'line-height:125%\'><st1:country-region w:st="on"><st1:place
   w:st="on"><span lang=EN-US style=\'mso-bidi-font-size:10.5pt;line-height:
    125%;font-family:Arial;mso-bidi-font-family:"Times New Roman"\'>'.$country.'</span></st1:place></st1:country-region><span
  lang=EN-US style=\'mso-bidi-font-size:10.5pt;line-height:125%;font-family:
  Arial;mso-bidi-font-family:"Times New Roman"\'><o:p></o:p></span></p>
  </td>
  <td width=144 colspan=2 valign=top style=\'width:108.0pt;border-top:none;
 ...
 <tr style=\'mso-yfti-irow:13;page-break-inside:avoid;height:31.25pt\'>
  ...
  -.51gd;text-align:center;line-height:125%\'><span lang=EN-US style=\'mso-bidi-font-size:
  10.5pt;line-height:125%;font-family:Arial;mso-bidi-font-family:"Times New Roman"\'>No.
  of Items<o:p></o:p></span></p>
  <p class=MsoNormal align=center style=\'margin-right:-5.35pt;mso-para-margin-right:
  -.51gd;text-align:center;line-height:125%\'><span style=\'mso-bidi-font-size:
  10.5pt;line-height:125%;font-family:宋体;mso-ascii-font-family:Arial;
  ...
  -.46gd;text-align:center;line-height:125%\'><span lang=EN-US style=\'mso-bidi-font-size:
...
';
    echo $html;
    $word->save(dirname(__FILE__) . '/invoice/' . $wordname);
    ob_flush();//每次执行前刷新缓存
    flush();
}