...
$order['signature'] = 'Claire';
$order['invoice_date'] = date('M.d, Y', time());
...
$html .= '<table cellpadding="3" class="table">'.
    ...
    '<td width="126" align="center" class="title">HS Code<br />海 关 编 码</td>'.
    ...
    '</tr>'.
    '<tr>'.
    '<td width="126" align="center">Handset</td>'.
    '<td width="126" align="center">8529909090</td>'.
