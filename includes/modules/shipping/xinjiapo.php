 ...
 * Time: 11:32
 */
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/xinjiapo.php';
...
if (isset($set_modules) && $set_modules == TRUE) {
    ...
    $modules[$i]['code']    = 'xinjiapo';
    $modules[$i]['version'] = '1.1.0';
    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'xinjiapo_express_desc';
    /* 配送方式是否支持货到付款 */
    $modules[$i]['cod']     = false;
    /* 插件的作者 */
